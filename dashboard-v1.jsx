...
function DashboardEditorial({ t, openEmployee, openSurvey, setRoute }) {
  ...
  return (
    <div className="main" data-screen-label="02 Dashboard · Editorial">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 32, marginTop: 14, alignItems: "end" }}>
          <div>
            <div style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
              <div className="serif" style={{ fontSize: 60, lineHeight: 1, letterSpacing: "-0.04em", fontWeight: 600 }}>
          ...
          <div>
            <LineChart data={D.COMPANY.trend} height={150} />
          </div>
        </div>
      </div>
          ...
          <div key={i} className="card">
            ...
            <div className="row between" style={{ alignItems: "baseline" }}>
              ...
              <span className={`stat-delta ${kpi.d.up ? "up" : "down"}`}>
                <Icon name={kpi.d.up ? "arrowUp" : "arrowDown"} size={11} />
                {kpi.d.val} <span className="muted" style={{ fontSize: 10.5, marginLeft: 2 }}>{t("since.lastMonth")}</span>
              </span>
            </div>
        ...
        <div className="card-flush">
          <div style={{ padding: "18px 20px 12px", borderBottom: "1px solid var(--line)" }}>
            <div className="row between">
              ...
              <button className="btn sm ghost" onClick={() => setRoute("employees")}>{t("label.viewAll")}</button>
            </div>
          </div>
          <div>
            {[...atRisk, ...watch].map((e, i) => (
              <div key={e.id} style={{
                padding: "var(--pad-row)",
                borderBottom: i < atRisk.length + watch.length - 1 ? "1px solid var(--line-2)" : "0",
      ...
      {/* Suggestions + Latest survey + Workload */}
      <div className="grid" style={{ gridTemplateColumns: "1fr 1fr" }}>
        ...
        <div className="card">
          <div className="row between">
            ...
            <button className="btn sm" onClick={() => openSurvey(D.SURVEYS[0])}>{t("label.openSurvey")}<Icon name="arrow" size={12}/></button>
          </div>
          <div className="row" style={{ marginTop: 14, gap: 18 }}>
            ...
            <div style={{ flex: 1 }}>
              <div className="muted" style={{ fontSize: 12 }}>
                {D.SURVEYS[0].responses}/{D.SURVEYS[0].sent} {t("lang")==="ES"?"respondieron":"answered"}
              </div>
              ...
              <div key={i} className="row" style={{ alignItems: "flex-start", gap: 10 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div className="row" style={{ gap: 8, marginTop: 4 }}>
                    ...
                    <span className={`pill ${r.sentiment === "positive" ? "olive" : r.sentiment === "negative" ? "rose" : ""}`} style={{ fontSize: 10.5, padding: "1px 7px" }}>
      ...
      {/* Workload + Recent announcements + recruit */}
      <div className="grid" style={{ gridTemplateColumns: "0.9fr 1.1fr 1fr" }}>
        ...
        <div className="card">
          <div className="row between">
            ...
            <button className="btn sm ghost" onClick={() => setRoute("announce")}>{t("label.viewAll")}</button>
          </div>
